...
//    	int x = 0, y = 12;
//    	 GeoPoint o = new GeoPoint(0,0);
//         PanoramaParameters pp = new PanoramaParameters(o, 2000, toRadians(45), toRadians(20), 300_000, 50, 20);
//         PanoramaComputer pc = new PanoramaComputer(wavyContDEM());
//         Panorama p = pc.computePanorama(pp);
//         assertEquals(WAVY_EXPECTED_DATA[3+12*5], p.elevationAt(x, y), 1e-5);
//    }
